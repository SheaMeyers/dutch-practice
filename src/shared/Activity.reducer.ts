...
const reducer = (questions: Question[], questionKey: string, orderingKey: string, getOptions: (...args: any[]) => any) => (state: ActivityState, action: DispatcherActions): ActivityState => {
    switch (action.type) {
        case 'nextQuestion':
